...
public class TransportManager {
	...
	public static ArrayList<CarFacade> downloadCarList(HashMap<String, String> params, Activity activity) throws ClientProtocolException, IOException{
		String ListUrl = "";
		SharedPreferences prefs = activity.getSharedPreferences(activity.getResources().getString(R.string.shared_prefs), 0);
	...
	public static Item downloadItem(HashMap<String, String> params, Activity activity) throws ClientProtocolException, IOException{
		String ItemUrl = "";
		SharedPreferences prefs = activity.getSharedPreferences(activity.getResources().getString(R.string.shared_prefs), 0);		
		int langID = prefs.getInt("Lang", LANG_EN);
		switch (langID) {
